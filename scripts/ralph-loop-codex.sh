...
if [ "$HAS_SPECS" = false ]; then
    echo -e "${YELLOW}No root-level markdown specs found in specs/.${NC}"
    echo -e "${CYAN}Create a file like specs/001-your-task.md from templates/spec-template.md first.${NC}"
    exit 0
fi
