...
You are implementing all root-level specifications in the `specs/` folder for this project.
...
For each numbered markdown spec in `specs/` (process in numerical order: 001, 002, 003, etc.):

1. **Read the spec file**: `specs/NNN-feature-name.md`
